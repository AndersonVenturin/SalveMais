-- Atualizar função para lidar com avaliação somente de usuário (quando dono do produto avalia)
...
BEGIN
  ...
  -- Inserir avaliação do produto apenas se avaliacao > 0
  IF p_avaliacao_produto > 0 THEN
  ...
  -- Inserir avaliação do usuário (sempre obrigatória)
